  ...
  render() {
    return (
      ...
      >
        ...
        <symbol id="calendar" viewBox="0 0 14 15">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M12.5 1.558H11V.519A.51.51 0 0010.5 0a.51.51 0 00-.5.52v1.038H4V.519A.51.51 0 003.5 0a.51.51 0 00-.5.52v1.038H1.5c-.828 0-1.5.697-1.5 1.557v9.866c0 .86.672 1.558 1.5 1.558h11c.828 0 1.5-.698 1.5-1.558V3.115c0-.86-.672-1.557-1.5-1.557zM13 12.98a.51.51 0 01-.5.519h-11a.51.51 0 01-.5-.52V6.23h12v6.75zM1 5.192h12V3.115a.51.51 0 00-.5-.519H11v1.039a.51.51 0 01-.5.519.51.51 0 01-.5-.52V2.597H4v1.039a.51.51 0 01-.5.519.51.51 0 01-.5-.52V2.597H1.5a.51.51 0 00-.5.52v2.076z"
            fill="currentColor"
          />
          <path
            d="M4 7.27H3a.51.51 0 00-.5.519c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM7.5 7.27h-1a.51.51 0 00-.5.519c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM11 7.27h-1a.51.51 0 00-.5.519c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM4 9.346H3a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM7.5 9.346h-1a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM11 9.346h-1a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM4 11.423H3a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM7.5 11.423h-1a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519zM11 11.423h-1a.51.51 0 00-.5.52c0 .286.224.519.5.519h1a.51.51 0 00.5-.52.51.51 0 00-.5-.519z"
            fill="currentColor"
          />
        </symbol>

        <symbol id="shield" viewBox="0 0 44 58">
          <path
            d="M21.799.018c1.463-.176 3.371 1.017 4.736 1.475 4.102 1.375 8.177 2.9 12.235 4.405 1.344.5 4.237.945 4.939 2.296.513.989.191 2.694.191 3.783v8.875c0 8.06.633 16.427-3.742 23.623-1.15 1.889-2.563 3.55-4.151 5.088-1.867 1.807-4.078 3.306-6.315 4.621a81.965 81.965 0 01-5.13 2.788c-.766.38-1.626.968-2.5 1.025-.857.055-1.763-.595-2.5-.96-2.019-1.002-4.003-2.057-5.92-3.24-2.533-1.565-4.924-3.364-6.961-5.537C-.563 40.532.091 30.113.091 20.33v-8.353c0-1.066-.301-2.682.192-3.654.77-1.517 3.831-2.007 5.334-2.525 3.657-1.26 7.287-2.627 10.92-3.96 1.643-.602 3.516-1.61 5.262-1.82m0 3.817c-1.708.222-3.526 1.221-5.131 1.822-2.834 1.06-5.737 1.947-8.552 3.057-.936.37-3.805.823-4.262 1.752-.37.754-.08 2.244-.08 3.077v7.309c0 8.573-.77 17.4 5.19 24.406 1.563 1.837 3.498 3.303 5.467 4.68 1.675 1.17 3.484 2.1 5.263 3.095.63.352 1.62 1.068 2.368 1.021.745-.047 1.602-.686 2.236-1.04 1.46-.817 2.917-1.598 4.342-2.48a30.632 30.632 0 005.915-4.754c6.455-6.7 5.662-15.868 5.662-24.406v-7.7c0-.864.306-2.428-.08-3.208-.424-.86-3.243-1.385-4.13-1.71-3.282-1.204-6.588-2.346-9.867-3.559-1.192-.441-3.056-1.53-4.341-1.362m-1.053 32.417h-.132l-6.183-6.134c-.48-.476-2.081-1.63-2.078-2.35.004-.827 1.785-2.058 2.341-2.61 1.521 1.098 2.898 2.683 4.188 4.042.408.43 1.209 1.572 1.864 1.564.814-.01 2.082-1.798 2.631-2.342l6.447-6.395c.518-.515 1.588-2.044 2.368-2.064.793-.02 2.65 2.02 2.187 2.716-1.094 1.638-3.023 3.048-4.424 4.438z"
            fill="currentColor"
          />
        </symbol>
        ...
        <symbol id="arrow-left" viewBox="0 0 17 12">
          <path
            d="M6.787 1.88L3.655 5.142H16.5v1.716H3.655l3.132 3.262-1.166 1.213L.5 6 5.621.667 6.786 1.88z"
            fill="currentColor"
          />
        </symbol>

        <symbol id="download" viewBox="0 0 23 23">
          <path
            fill="currentColor"
            d="M21.203 14v6.286a.903.903 0 01-.898.905H2.695a.903.903 0 01-.898-.905V14H0v6.286A2.708 2.708 0 002.695 23h17.61A2.708 2.708 0 0023 20.286V14h-1.797z"
          />
          <path
            fill="currentColor"
            d="M16.635 10.927l-3.67 3.523V0h-1.93v14.45l-3.67-3.523L6 12.238 12 18l6-5.762z"
          />
        </symbol>
